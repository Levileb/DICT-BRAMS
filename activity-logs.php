...
<body class="bg-gray-100">
    ...
    <div id="archive-log" class="tab-content container mx-auto flex items-center justify-center h-screen px-8 py-6 max-w-2xl my-8 bg-white rounded-lg shadow-md">
    <div class="inner-container p-6 w-full">
    ...
    <div id="household-log" class="tab-content container mx-auto flex items-center justify-center h-screen px-8 py-6 max-w-2xl my-8 bg-white rounded-lg shadow-md">
    <div class="inner-container p-6 w-full">
